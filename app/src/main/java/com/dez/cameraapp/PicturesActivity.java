...
/*
    ...
    ListView allPicturesListView;

    PictureListAdapter allPictureListAdapter;
    Cursor allPicturesCursor;

    Button addPictureButton;
    Button searchPicturesButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchPicture = (EditText)findViewById(R.id.button_search_for_pictures);


        addPictureButton = (Button)findViewById(R.id.add_new_picture_tag);
        searchPicturesButton = (Button)findViewById(R.id.button_search_for_pictures);


        //Get reference to ListView
        allPicturesListView = (ListView)findViewById(R.id.all_pictures_Listview);

        //set up Cursor
        allPicturesCursor = dbManager.getCursorAll();
        //Create ProductlistAdapter using this cursor
        allPictureListAdapter = new PictureListAdapter(this, allPicturesCursor, false);

        //Configure ListView to use this PictureListAdapter
        allPicturesListView.setAdapter(allPictureListAdapter);




        searchPicturesButton.setOnClickListener(new View.OnClickListener(){
    ...
    private void takePhoto() {
        ...
        if (pictureIntent.resolveActivity(getPackageManager()) == null) {
            Toast.makeText(PicturesActivity.this, "Your device does not have a camera", Toast.LENGTH_LONG).show();
            ...
            try {
                ...
                imageFileUri = FileProvider.getUriForFile(PicturesActivity.this, "com.dez.cameraapp", imageFile);
